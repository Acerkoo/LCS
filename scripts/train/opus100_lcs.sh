...
data_dir=$repo_dir/data/opus100/s_enc_t_dec
code_dir=$repo_dir/fairseq/fairseq-converter
model_dir=$repo_dir/checkpoints/opus100/$signature
...
python $code_dir/fairseq_cli/train.py $data_dir/data-bin \
    ...
    --encoder-layers 6 --decoder-layers 6 --encoder-converter-layer 5 \
    ...
    --stop-min-lr -1 \
    --max-tokens 3200 \
    --max-update 400000 --save-interval-updates 5000 \
    --eval-bleu \
